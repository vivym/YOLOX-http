...
def make_parser():
    ...
    parser.add_argument("-expn", "--experiment-name", type=str, default="http_api")
...
class Predictor(object):
    ...
    def get_results(self, output, img_info, cls_conf=0.35):
        ratio = img_info["ratio"]
        img = img_info["raw_img"]
        if output is None:
            return {}
...
async def detect(image: UploadFile):
    ...
    outputs, img_info = predictor.inference(file_path)
    return predictor.get_results(outputs[0], img_info, predictor.confthre)
